...
The public landing page requires selection of Tanzania, Kenya, Nigeria, Pakistan or Rwanda before authentication. No hospital directory is exposed before sign-in. The selected country controls national/ministry branding and is submitted as part of the authentication request.
...
- Pakistan federal and provincial teaching facilities with Pakistani synthetic names, +92 phone formats, Sehat Sahulat coverage labels, and PK identifiers.
- Rwanda university, teaching, referral and district facilities with Rwandan synthetic names, +250 phone formats, Mutuelle de Santé coverage labels, and RW identifiers.
