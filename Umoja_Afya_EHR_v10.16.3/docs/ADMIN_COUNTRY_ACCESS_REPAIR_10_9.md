...
- `platform.admin`: full administrator function and department catalogs, every active facility, and Tanzania, Kenya, Nigeria, Pakistan and Rwanda country contexts.
...
- `pk.admin`: full administrator function and department catalogs, all active Pakistani facilities, Pakistan only.
- `rw.admin`: full administrator function and department catalogs, all active Rwandan facilities, Rwanda only.
...
After completion, sign out fully and sign in again. Select the matching country for `tz.admin`, `ke.admin`, `ng.admin`, `pk.admin` or `rw.admin`. `platform.admin` may use any of the five country selectors.
