...
class UserAccount(Base):
    ...
    profile_photo_mime: Mapped[str | None] = mapped_column(String(50), nullable=True)
    profile_photo_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    profile_photo_updated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    profile_photo_updated_by: Mapped[str | None] = mapped_column(String(180), nullable=True)
...
class Charge(Base):
    ...
    currency_code: Mapped[str] = mapped_column(String(3), default="TZS")
