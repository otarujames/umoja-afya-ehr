...
class Settings(BaseModel):
    ...
    bootstrap_token: str = ""
    first_run_setup_enabled: bool = True
    ...
    def validate_runtime(self) -> None:
        ...
        if environment in {"staging", "production"}:
            ...
            if self.first_run_setup_enabled and len(self.bootstrap_token) < 32:
                raise ConfigurationError("A random UMOJA_BOOTSTRAP_TOKEN or UMOJA_BOOTSTRAP_TOKEN_FILE of at least 32 characters is required.")
            ...
            if self.first_run_setup_enabled and len(self.bootstrap_token) < 32:
                raise ConfigurationError("A random UMOJA_BOOTSTRAP_TOKEN or UMOJA_BOOTSTRAP_TOKEN_FILE of at least 32 characters is required in review.")
...
def get_settings() -> Settings:
    ...
    bootstrap_token = _read_secret(
        value_env="UMOJA_BOOTSTRAP_TOKEN",
        file_env="UMOJA_BOOTSTRAP_TOKEN_FILE",
        default="",
    )
    ...
    return Settings(
        ...
        first_run_setup_enabled=_bool_env("UMOJA_FIRST_RUN_SETUP", True),
