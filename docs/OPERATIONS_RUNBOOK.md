...
3. Generate and synchronize `secrets/preloaded_users.json` using `scripts/init-production.sh` and prestart.
4. Verify the global superuser plus country-scoped role accounts, then move the roster to an approved password vault.
