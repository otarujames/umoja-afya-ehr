...
from ..enhancement_models import DeviceEndpoint, DeviceReading, ManagedEvent, OrderCatalogItem, UserMessage
...
def order_catalog(
    ...
    items = list(db.scalars(query.order_by(OrderCatalogItem.category, OrderCatalogItem.display_name).offset(offset).limit(limit)).all())
    return {
        "total": total,
        "offset": offset,
        "limit": limit,
